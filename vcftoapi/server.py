...
from vcftoapi import log
from vcftoapi.lib.annotation_data import AnnotationData
from vcftoapi.lib.genotype_data import GenotypeData

from vcftoapi.lib.utils import ApiError
from vcftoapi.lib.utils import StrictEncoder
from vcftoapi.lib.utils import generate_distance_matrix_for_genotype, generate_distance_matrix_for_sequence


from vcftoapi.lib.utils import to_newick, sequence_vcf
...
def create_app(filename_config_yaml = 'vcftoapi.config.yml', config_runtime=None):
    ...
    if config_runtime is not None:
        ...
        try:
            ...
            log.error('vcftoapi config file `vcftoapi.config.yml` not found in current directory!')
            exit(1)
    ...
    def __home():
        return 'vcftoapi server is running'
